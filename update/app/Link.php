        ...
        if (!empty(@$userMenuAction)) {
            foreach ($userMenuAction as $action) {
                if (in_array($action->id, @$rolePermission)) {
                    ...
                    $data_link .= '<a href="'.route($action->actionLink,$id).'" data-toggle="tooltip" class="viewLink" data-toggle="tooltip" data-original-title="'.$action->actionName.'" data-id="'.$id.'"> <i class="fa fa-eye text-success m-r-10"></i> </a>';
                    }
                    ...
                    $data_link .= '<a href="'.route($action->actionLink,$id).'" class="sendIcon" data-toggle="tooltip" data-original-title="'.$action->actionName.'"> <i class="fa fa-paper-plane text-success m-r-10"></i> </a>';
                    }
                }
            }
        }
