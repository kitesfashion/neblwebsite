    ...
    <table id="articles" class="table table-bordered table-striped datatable"  name="articles">
        ...
        <tbody id="tbody">
            ...
            @php 
                ...
                $menu = Menu::where('id',$article->menuId)->first();
                if(@$parentArticle){
        	...
        	<tr class="row_{{$article->id}}">
                <td>{{ $i }}</td>
                 ...
                 <td>
                     ...
                     <a data-fancybox="gallery" href="{{asset(@$article->firstHomeImage)}}">
                        <img src="{{asset('/').@$article->firstHomeImage}}" style="height: 40px;">
                     </a>
                        
                    <?php }else{ ?>
                        <a data-fancybox="gallery" href="{{asset('/public/frontend/noImage.jpg')}}">
                 ...
                 <td>
                     <?php if (file_exists(@$article->firstInnerImage)) { ?> 
                        <a data-fancybox="gallery" href="{{asset(@$article->firstInnerImage)}}">
