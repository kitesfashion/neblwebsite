            ...
            <select name="parentArticleParam" class="form-control chosen-select parentArticle">
                ...
                @foreach ($parentArticleList as $parentArticle)
                   @php
                    ...
                    if(@$childParentArticle->id !=9 && @$childParentArticle->id !=2 &&  $parentArticle->id != 9 && $parentArticle->parentArticle != 9 && $parentArticle->id != 2 && $parentArticle->parentArticle != 2){
    ...
    <table id="articles" class="table table-bordered table-striped datatable"  name="articles">
        ...
        <tbody id="tbody">
            ...
            <?php 
                ...
                if(@$subParentArticle->id != 9 && @$childParentArticle->id != 9 && @$collectionProductParentArticle->id != 9 && $article->id != 9 && $article->id != 2 && $article->parentArticle != 2){
